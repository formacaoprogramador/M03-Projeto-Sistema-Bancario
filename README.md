...
O objetivo do projeto é treinar os conhecimentos adquiridos ao longo da [Formação Programador](https://www.formacaoprogramador.com.br/), durante o módulo 03, utilizando *estruturas de repetição* e *estruturas de dados* para criar um script em Python que possibilite a simulação de operações bancárias do dia a dia.
...
- [@lucastorress](https://www.github.com/lucastorress)
